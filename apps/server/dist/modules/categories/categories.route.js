 ...
 *               $ref: '#/components/schemas/Error'
 */
categoriesRouter.post("/", admin_1.requireAdmin, categoriesController.create);
/**
 * @swagger
 * /api/v1/categories/{id}:
 *   put:
 ...
 *               $ref: '#/components/schemas/Error'
 */
categoriesRouter.put("/:id", admin_1.requireAdmin, categoriesController.update);
/**
 * @swagger
 * /api/v1/categories/{id}:
 *   delete:
 ...
 *               $ref: '#/components/schemas/Error'
 */
categoriesRouter.delete("/:id", admin_1.requireAdmin, categoriesController.delete);
